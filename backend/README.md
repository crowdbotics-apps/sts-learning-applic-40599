...
## Project Structure
    ...
    ├── sts_learning_applic_40599  # Django project configurations
...
1. Clone this repo and `cd sts_learning_applic_40599`
...
2. Clone this repo and `cd sts_learning_applic_40599`
